...
#define BELL 13 // door bell switch
#define PHOTO 14

#define LED 4 // used as camera flash
...
void myTimerEvent(){
  ...
  Blynk.virtualWrite(V2, Serial.read());
  //
  //  This part of code needs to framed according to widgets in the app.
